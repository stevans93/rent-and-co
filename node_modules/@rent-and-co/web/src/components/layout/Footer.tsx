        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1 text-center md:text-left">
            ...
            <div className="space-y-2 text-sm text-gray-400">
              <p className="text-white font-medium">{t.footer.aboutTitle}</p>
              <p>{t.footer.tagline}</p>
              <p>{t.footer.companyName}</p>
              <p>{t.footer.pib}: XXXXXX</p>
              <p>{t.footer.mb}: XXXXXX</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 text-center md:text-left">
            ...
            <div className="flex flex-col space-y-2 max-w-xs mx-auto md:mx-0">
              <input
                type="email"
                placeholder="Email"
                className="bg-[#2a2a2a] border border-gray-700 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-[#e85d45] text-center md:text-left"
              />
              <button className="bg-[#e85d45] hover:bg-[#d14d35] rounded-lg px-4 py-2 text-sm transition-colors">
                {t.footer.subscribe}
              </button>
            </div>
          </div>
          ...
          {/* Useful Links */}
          <div className="lg:col-span-1 text-center md:text-left">
            <h4 className="text-sm font-medium mb-4 uppercase">{t.footer.usefulLinks}</h4>
          ...
          {/* Explore Rent&Co */}
          <div className="lg:col-span-1 text-center md:text-left">
            <h4 className="text-sm font-medium mb-4 uppercase">{t.footer.exploreTitle}</h4>
            <ul className="space-y-2">
              <li>
